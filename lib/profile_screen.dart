      ...
      body: SafeArea(
        child: userId == null
          ...
          builder: (context, snapshot) {
            ...
            final bio = data['bio'] ?? 'No bio available. Add something about yourself!';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flex(
                        ...
                        children: [
                          Flexible(child: _buildStatCard("Total Walks", "128")),
                          const SizedBox(width: 12),
                          Flexible(child: _buildStatCard("Total Impact", "256 hrs")),
                        ],
                      ),
                      const SizedBox(height: 24),
